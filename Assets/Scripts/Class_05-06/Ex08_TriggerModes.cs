...
public class Ex08_TriggerModes : MonoBehaviour
{
    public enum Shape
    {
        Wedge,
    ...
    void DrawConeGizmo()
    {
        ...
        {
            //01:18:00 ela explica essa parte
            float a = FovRad / 2;//Alfa
    ...
    {
        return Mathf.Acos(Mathf.Clamp(Vector3.Dot(a, b), -1, 1));//O arcoseno do produto vetorial entre dois vetores, é o angulo entre eles
    }
    ...
    bool ConeContains(Vector3 position)
    {
        ...
        //return Vector3.Angle(transform.forward, dirToTarget) < fovDeg/2;//Calcula ângulo entre 2 vetores
    }
