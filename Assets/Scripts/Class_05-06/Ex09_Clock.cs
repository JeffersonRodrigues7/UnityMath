...
public class Ex09_Clock : MonoBehaviour
{
    [Range(0, 0.2f)]
    ...
    void OnDrawGizmos()
    {
        ...
        Handles.DrawWireDisc(default, Vector3.forward, 1);//desenhando círculo
    ...
    {
        /**Negando t eu faço o ponteiro girar na outra direção
         * (0.25 - t) faço com que o ponteiro comece apontando para cima, caso contrário ele começaria apontando para direita
         * 0.25 é um quarto do relógio
         * 
         */
